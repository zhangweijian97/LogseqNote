...
####
$$\boldsymbol{\Sigma} = \boldsymbol{U}\boldsymbol{\Lambda} \boldsymbol{U}^\top = \left[ \begin{matrix} \boldsymbol{a}_{1}^{2}& \boldsymbol{a}^2_2& \boldsymbol{a}^2_3& \boldsymbol{a}^2_4 \end{matrix} \right]$$
####
