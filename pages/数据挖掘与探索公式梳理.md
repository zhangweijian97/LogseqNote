...
####
$$\boldsymbol{\Sigma} = \boldsymbol{U}\boldsymbol{\Lambda} \boldsymbol{U}^\top = \left[ \begin{matrix} \boldsymbol{a}_{1}^{2}& \boldsymbol{a}^2_2& \boldsymbol{a}^2_3& \boldsymbol{a}^2_4 \end{matrix} \right]\left[ \begin{matrix} 1 & 0& 0& 0\\ 0& 16 & 0& 0\\ 0& 0& 9 & 0\\ 0& 0& 0& 4 \end{matrix} \right]\left[ \begin{matrix} \boldsymbol{a}_{1}^{2}\\ \boldsymbol{a}^2_2\\ \boldsymbol{a}_{3}^{2}\\\boldsymbol{a}_{4}^2 \end{matrix} \right]$$
### therefore, we got
#### $\lambda_1 = 16$, $\lambda_2 = 9$, $\lambda_1 = 4$, $\lambda_1 = 1$
### therfore, by lecture notes, fraction of variance explained is
####
$$\cfrac{\sum_{m=1}^k\lambda_m}{\sum_{m=1}^d\lambda_m} = \cfrac{16 + 9}{16 + 9 + 4+ 1} = $$
##
