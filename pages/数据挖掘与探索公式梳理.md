...
### by lecture notes:
####
$$\boldsymbol{x} = \boldsymbol{W}\boldsymbol{z}+\boldsymbol{m} = \boldsymbol{W}\boldsymbol{z}+\boldsymbol{\mu}+\boldsymbol{\epsilon}$$
### because
####
$$
...
####
$$
\mathbf{a}_{1} z_{1}-4 \mathbf{a}_{2} z_{2}+3 \mathbf{a}_{3} z_{3}+2 \mathbf{a}_{4} z_{4}+\mathbf{m}
$$
## Reference
### DME lecture notes