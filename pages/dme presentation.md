...
## 演讲稿
### Now we have the ICA model that represents the observed variable x and unknow independent component s. Next, we should find out the objective function to find the solution of s.
讲
###
##
�够简化计算
