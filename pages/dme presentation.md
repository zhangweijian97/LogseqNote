...
### Before going to optimization method, the paper mentioned some data preprocessing methods, such as centering, whitening and an application-dependent method, the band-pass filtering.
讲
###
##
�够简化计算
