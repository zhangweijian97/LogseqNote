...
### AttnGAN利用Attention机制，通过计算单词和图片的sub-region的attention，
### （这里水一下AttnGAN的架构）AttnGAN用text encoder和image encoder将文本和图片map到同一个空间，提出了attention-driven image text matching score来计算
