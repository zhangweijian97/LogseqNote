...
### 下午4点 IPP tutorial
#### list task
##### generally, implement a model based on knowledge enhanced pretrained model that uses geographic data to help to solve question answering task
...
##### think about method to train the model and test the thinking and if fail, think another one (1 month)
#####
